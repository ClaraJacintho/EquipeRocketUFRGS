...
public class Btree {
    ...
    public void insereFull(int key, long offset, int spot) {  //SPLIT         corrigir tirar spot
        Bnode novoNode = new Bnode(t);
        Bnode alvo = nodo.get(spot);
        int t = novoNode.t, i, chave; 
        long off;
    ...
    public void insereNoPai(int key, long offset, int spot, int filhoD) {
        int i, chave;
        long off;
        if (spot == -1) {                   //se a raiz estava cheia
            Bnode novissimo = new Bnode(t);
            novissimo.papai = -1;
            ...
            Bnode novoNode = new Bnode(t), alvo = nodo.get(spot);
            int t = alvo.t;
