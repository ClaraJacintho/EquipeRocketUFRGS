...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void ButtonBackMoves1ActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        CardLayout card = (CardLayout) PainelPrincipal.getLayout();
        card.show(PainelPrincipal, "PainelMenu");
    }                                                

    private void ButtonMovesActionPerformed(java.awt.event.ActionEvent evt) {                                            
        CardLayout card = (CardLayout) PainelPrincipal.getLayout();
        try {
...
//                }
    ...
    private void ButtonBackPokedex1ActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        CardLayout card = (CardLayout) PainelPrincipal.getLayout();
        card.show(PainelPrincipal, "PainelMenu");
    }                                                  

    private void ButtonPokedexActionPerformed(java.awt.event.ActionEvent evt) {                                              
        try {
            CardLayout card = (CardLayout) PainelPrincipal.getLayout();
    ...
    Pokemon pkm;
    private void ButtonBackSearch1ActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        CardLayout card = (CardLayout) PainelPrincipal.getLayout();
        card.show(PainelPrincipal, "PainelMenu");
    }                                                 

    private void ButtonBackSearch2ActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        CardLayout card = (CardLayout) PainelPrincipal.getLayout();
        card.show(PainelPrincipal, "PainelSearch1");
    }                                                 
    ...
    private void ButtonBackSearchMovesActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        CardLayout card = (CardLayout) PainelPrincipal.getLayout();
        card.show(PainelPrincipal, "PainelSearch2");
    }                                                     

    private void ButtonSearchMovesActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        CardLayout card = (CardLayout) PainelPrincipal.getLayout();
